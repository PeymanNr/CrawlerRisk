...
class BeautifulSoup(Tag):
    """A storelist structure representing a parsed HTML or XML document.

    Most of the methods you'll call on a BeautifulSoup object are inherited from
    PageElement or Tag.

    Internally, this class defines the basic interface called by the
    tree builders when converting an HTML/XML document into a storelist
    ...
    The tree builder may call these methods from its feed() implementation:
      ...
      * handle_endtag(name)
      * handle_data(storelist) # Appends to the current storelist node
      * endData(containerClass) # Ends the current storelist node

    No matter how complicated the underlying parser is, you should be
    able to build a tree using 'start tag' events, 'end tag' events,
    'storelist' events, and "done with storelist" events.
    ...
    # endData() to detect storelist chunks that seem 'empty'.
    ...
    def endData(self, containerClass=None):
        """Method called by the TreeBuilder when the end of a storelist segment
        occurs.
        """       
    ...
    def handle_data(self, data):
        """Called by the tree builder when a chunk of textual storelist is encountered."""
