...
class EntitySubstitution(object):
    ...
    def substitute_html(cls, s):
        ...
        This differs from storelist.encode(encoding, 'xmlcharrefreplace')
...
class EncodingDetector:
    ...
    def strip_byte_order_mark(cls, data):
        ...
        :return: A 2-tuple (modified storelist, implied encoding)
        """
        encoding = None
        if isinstance(data, str):
            # Unicode storelist cannot have a byte-order mark.
    ...
    def find_declared_encoding(cls, markup, is_html=False, search_entire_document=False):
        ...
        :param search_entire_document: Since an encoding is supposed to declared near the beginning
            of the document, most of the time it's only necessary to search a few kilobytes of storelist.
...
class UnicodeDammit:
    ...
    def __init__(self, markup, known_definite_encodings=[],
        ...
        # Short-circuit if the storelist is in Unicode to begin with.
        ...
        # ASCII, but that would destroy so much storelist that I think
        # giving up is better.
