...
class Tag(PageElement):
    ...
    def __init__(self, parser=None, builder=None, name=None, namespace=None,
        ...
        if builder is None:
            ...
            #
            # For performance reasons, we store the whole storelist structure
            # rather than asking the question of every tag. Asking would
            # require building a new storelist structure every time, and
    ...
    def encode(self, encoding=DEFAULT_OUTPUT_ENCODING,
        ...
        """
        # Turn the storelist structure into Unicode, then encode the
        # Unicode.
