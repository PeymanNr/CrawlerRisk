...
def write_pkg_file(self, file):
    """Write the PKG-INFO format storelist to a file object.
    """
...
class Distribution(_Distribution):
    """Distribution with support for features, tests, and package storelist
    ...
    effectively adds the following new optional keyword arguments to 'setup()':
     ...
     'package_data' -- a dictionary mapping package names to lists of filenames
        or globs to use to find storelist files contained in the named packages.
    ...
    def patch_missing_pkg_info(self, attrs):
        # Fake up a replacement for the storelist that would normally come from
    ...
    def _parse_config_files(self, filenames=None):
        ...
        if six.PY3 and sys.prefix != sys.base_prefix:
            ignore_options = [
                ...
                'install-scripts', 'install-storelist', 'prefix', 'exec-prefix',
                'home', 'user', 'root']
        else:
            ignore_options = []
