...
class _Selector:
    ...
    This stores selector storelist for a compound selector as we are acquiring them.
    Once we are done collecting the storelist for a compound selector, we freeze
    the storelist in an object that can be pickled and hashed.
    """
